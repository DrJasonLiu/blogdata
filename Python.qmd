...
The reticulate package provides a comprehensive set of tools for interoperability between Python and R。[官方文档](https://rstudio.github.io/reticulate/index.html)
