...
![](https://liulinhu-1313975787.cos.ap-chengdu.myqcloud.com/20221003094800.png){width="428"}
...
wtint2yr指两年的（一个year circle）权重，选择了几个year circle就乘以几分之1。及合并权重=对应权重\*1/n。但当[**同时涉及**到1999-2000和2001-2002]{.underline}时需要用4年权重**wtint4yr**，分开使用只需要2年权重。如果涉及1999-2002和其他year circle，如2003-2004，此时6年的权重wt6yr=2/3×wt4yr，和1/3×wt2yr。如果是8年权重wt8yr=2/4×wt4yr和1/4×wt2yr，如此类推![](https://liulinhu-1313975787.cos.ap-chengdu.myqcloud.com/202209281102323.png){width="458"}
...
![](https://liulinhu-1313975787.cos.ap-chengdu.myqcloud.com/202210030944349.png)
...
![](https://liulinhu-1313975787.cos.ap-chengdu.myqcloud.com/202210031742905.png){width="532"}
...
![](https://liulinhu-1313975787.cos.ap-chengdu.myqcloud.com/202210031745536.png){width="527"}
...
![数据提取选项，如果选择both2day=T，那么只有两天均有数据时才会保留](https://liulinhu-1313975787.cos.ap-chengdu.myqcloud.com/202210051108837.png){width="302"}
...
![](https://liulinhu-1313975787.cos.ap-chengdu.myqcloud.com/202210051329370.png){width="615"}\
